...
op=open("9A_PC_Correlation_buckets_more_than_100.txt","w")
...
op.write("for more than 100 pc\n*************************************************************\n\n")
op.write("Max PC and cumulative citation count(0-5) after 10 years\t")
op.write(str(pc(max_p1,list_t10_1)))
op.write("\n")

op.write("Max PC and cumulative citation count(5-10) after 10 years\t")
op.write(str(pc(max_p2,list_t10_2)))
op.write("\n")

op.write("Max PC and cumulative citation count(10-20) after 10 years\t")
op.write(str(pc(max_p3,list_t10_3)))
op.write("\n")

op.write("Max PC and cumulative citation count(20-100) after 10 years\t")
op.write(str(pc(max_p4,list_t10_4)))
op.write("\n")

op.write("Max PC and cumulative citation count(>=100) after 10 years\t")
