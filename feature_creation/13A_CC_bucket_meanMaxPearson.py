...
max_p5=[]
max_p6=[]
op=open("22A_CC_maxMeanAnalysis_results.txt","w")
with open("13_CC_analysis.txt","r") as in_file:
	for line in in_file:
		entry=line[:-1].split("\t");
		# print entry
...
op.write("Correlation Values for cc(taken mean/median max publication count citer author) and citaion count after 10 years\n\n")
op.write("(0-5)\t")
