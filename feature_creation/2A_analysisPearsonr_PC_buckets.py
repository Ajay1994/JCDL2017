...
op=open("29J_PC_Correlation_buckets.txt","w")
...
op.write("Max PC and cumulative citation count(0-4) after 10 years\t")
op.write(str(pc(max_p1,list_t10_1)))
op.write("\n")

op.write("Max PC and cumulative citation count(4-10) after 10 years\t")
op.write(str(pc(max_p2,list_t10_2)))
op.write("\n")

op.write("Max PC and cumulative citation count(>=10) after 10 years\t")
